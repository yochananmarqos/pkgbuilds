...
sha256sums=('SKIP'
            ...
            '2f08413437e3319893a92af76ec214f33aedcbffc7a23781c724425cdc764753')
...
prepare() {
  ...
  # Temporary patch for protobuf 3.10 breaking compilation
  patch --forward --strip=1 --input="${srcdir}/anbox.patch"
}
